class State extends React.Component{
    ...
    render(){
        return <div id='state-demo' className='page-container'>
            ...
            <p className='state-p'>Here I have a json object that defines a name with a value of <a>{this.state.name}</a>, a date, in this case <a>{this.state.date}</a> and a list with <a>{this.state.list.length}</a> in it, feel free to change it, you will see it reflected in the various elements</p>
            {this.textArea}
