...
let container = document.getElementById('inner_cube');
let faces = [];
loop(54, function (i) {
...
function loop(int, callBack) {
  for (let i = 0; i < int; i++) callBack(i);
}